...
$appremove = 'Earth'
$URL = 'http://dl.google.com/earth/client/advanced/current/GoogleEarthWin.exe'
$file = 'GoogleEarthWin.exe'
$switches = '/S /v/qn /V""/qb""'
$appfolder = "C:\$ProgFiles\Google"
