...
$URL = 'http://www.plantronics.com/cgi-bin/download.cgi?type=software&path=&ID=PlantronicsURE.msi'
$file = 'PlantronicsURE.msi'
$switches = '/q ALLUSERS=1 DESKTOPICON=1 REBOOT=ReallySuppress'
